    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ...
            if (this.destinationSubscriberNumber != null)
                ((CalledPartyBCDNumberImpl) this.destinationSubscriberNumber).encodeAll(asnOutputStream,
                        Tag.CLASS_CONTEXT_SPECIFIC, _ID_destinationSubscriberNumber);

            if (this.callingPartyNumber != null)
                ((SMSAddressStringImpl) this.callingPartyNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.locationInformationMSC != null)
                ((LocationInformationImpl) this.locationInformationMSC).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.smscCAddress != null)
                ((ISDNAddressStringImpl) this.smscCAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_smscCAddress);

            if (this.timeAndTimezone != null)
                ((TimeAndTimezoneImpl) this.timeAndTimezone).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_timeAndTimezone);

            if (this.tPShortMessageSpecificInfo != null)
                ((TPShortMessageSpecificInfoImpl) this.tPShortMessageSpecificInfo).encodeAll(asnOutputStream,
                        Tag.CLASS_CONTEXT_SPECIFIC, _ID_tPShortMessageSpecificInfo);

            if (this.tPProtocolIdentifier != null)
                ((TPProtocolIdentifierImpl) this.tPProtocolIdentifier).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_tPProtocolIdentifier);

            if (this.tPDataCodingScheme != null)
                ((TPDataCodingSchemeImpl) this.tPDataCodingScheme).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _ID_tPDataCodingScheme);

            if (this.tPValidityPeriod != null)
                ((TPValidityPeriodImpl) this.tPValidityPeriod).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.smsReferenceNumber != null)
                ((CallReferenceNumberImpl) this.smsReferenceNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.calledPartyNumber != null)
                ((ISDNAddressStringImpl) this.calledPartyNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
