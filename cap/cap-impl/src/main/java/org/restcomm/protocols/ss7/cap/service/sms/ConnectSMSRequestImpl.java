    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ...
            if (this.callingPartysNumber != null)
                ((SMSAddressStringImpl) this.callingPartysNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.smscAddress != null)
                ((ISDNAddressStringImpl) this.smscAddress)
                        .encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_smscAddress);
