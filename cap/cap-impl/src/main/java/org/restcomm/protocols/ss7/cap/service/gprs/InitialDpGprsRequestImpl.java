    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        try {
            ...
            if (this.sgsnCapabilities != null)
                ((SGSNCapabilitiesImpl) this.sgsnCapabilities).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
            ...
            if (this.pdpInitiationType != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_pdpInitiationType, this.pdpInitiationType.getCode());
            ...
            if (this.secondaryPDPContext)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_secondaryPDPContext);
