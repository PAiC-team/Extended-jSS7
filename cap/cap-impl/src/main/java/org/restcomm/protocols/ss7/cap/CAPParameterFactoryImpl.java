...
public class CAPParameterFactoryImpl implements CAPParameterFactory {
    ...
    public Problem createProblemGeneral(GeneralProblemType generalProblemType) {
        ...
        pb.setGeneralProblemType(generalProblemType);
        return pb;
    }
    ...
    public Problem createProblemInvoke(InvokeProblemType invokeProblemType) {
        ...
        pb.setInvokeProblemType(invokeProblemType);
        return pb;
    }
    ...
    public Problem createProblemResult(ReturnResultProblemType returnResultProblemType) {
        ...
        pb.setReturnResultProblemType(returnResultProblemType);
        return pb;
    }
    ...
    public Problem createProblemError(ReturnErrorProblemType returnErrorProblemType) {
        ...
        pb.setReturnErrorProblemType(returnErrorProblemType);
        return pb;
    }
    ...
    @Override
    public RouteSelectFailureSpecificInfo createRouteSelectFailureSpecificInfo(CauseCap capFailureCause) {
        return new RouteSelectFailureSpecificInfoImpl(capFailureCause);
    }
    ...
    public QualityOfService createQualityOfService(GPRSQoS requestedQoS, GPRSQoS subscribedQoS, GPRSQoS negotiatedQoS,
            GPRSQoSExtension requestedQoSExtension, GPRSQoSExtension subscribedQoSExtension, GPRSQoSExtension negotiatedQoSExtension) {
        return new QualityOfServiceImpl(requestedQoS, subscribedQoS, negotiatedQoS, requestedQoSExtension, subscribedQoSExtension, negotiatedQoSExtension);
    }

    @Override
    public ROTimeGPRSIfTariffSwitch createROTimeGPRSIfTariffSwitch(Integer roTimeGPRSSinceLastTariffSwitch, Integer roTimeGPRSTariffSwitchInterval) {
    ...
    @Override
    public TimeGPRSIfTariffSwitch createTimeGPRSIfTariffSwitch(int timeGPRSSinceLastTariffSwitch, Integer timeGPRSTariffSwitchInterval) {
