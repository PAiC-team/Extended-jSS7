 ...
 *
 */
public class EntityReleasedGPRSRequestImpl extends GprsMessageImpl implements EntityReleasedGPRSRequest {

    public static final String _PrimitiveName = "EntityReleasedGPRSRequest";
    ...
    public EntityReleasedGPRSRequestImpl() {
    }

    public EntityReleasedGPRSRequestImpl(GPRSCause gprsCause, PDPID pdpID) {
        super();
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws CAPException {
        ...
        ((GPRSCauseImpl) this.gprsCause).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_gprsCause);
