...
public class RequestReportGPRSEventRequestTest {
    ...
    public void testDecodeLiveTrace() throws Exception {
        ...
        assertEquals(gprsEvent.get(2).getGPRSEventType(), GPRSEventType.disconnect);
    ...
    public void testEncodeLiveTrace() throws Exception {
        ...
        GPRSEvent event3 = new GPRSEventImpl(GPRSEventType.disconnect, MonitorMode.interrupted);
