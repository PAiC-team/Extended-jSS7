...
*
*/
public class EPSSubscriptionDataWithdrawTest {
    ...
    public void testDecode() throws Exception {
        ...
        int tag = asn.readTag();
        EPSSubscriptionDataWithdrawImpl asc = new EPSSubscriptionDataWithdrawImpl();
        asc.decodeAll(asn);
        ...
        tag = asn.readTag();
        asc = new EPSSubscriptionDataWithdrawImpl();
        asc.decodeAll(asn);
    ...
    public void testEncode() throws Exception {
        ...
        EPSSubscriptionDataWithdrawImpl asc = new EPSSubscriptionDataWithdrawImpl(true);
        ...
        arr.add(1);
        arr.add(12);
        asc = new EPSSubscriptionDataWithdrawImpl(arr);
