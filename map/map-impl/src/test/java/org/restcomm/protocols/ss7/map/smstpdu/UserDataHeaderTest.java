...
public class UserDataHeaderTest {
    ...
    public void testDecode() throws Exception {
        ...
        assertEquals(conc.getMessageSegmentCount(), 3);
        assertEquals(conc.getMessageSegmentNumber(), 2);
        ...
        assertEquals(conc.getMessageSegmentCount(), 2);
        assertEquals(conc.getMessageSegmentNumber(), 1);
