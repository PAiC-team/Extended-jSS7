...
//                2, 36, -128, 3, 0, -128, 0, -14, -125, 5, -111, -128, 55, 33, -12 };
    ...
    public void testDecode() throws Exception {
        ...
        assertFalse(mapOpenInfoImpl.getEricssonStyle());
        ...
        assertTrue(mapOpenInfoImpl.getEricssonStyle());
        assertTrue(mapOpenInfoImpl.getEricssonMsisdn().getAddress().equals("111222111222"));

        AddressString eriVlrNo = mapOpenInfoImpl.getEricssonVlrNo();
    ...
    public void testEncode() throws Exception {
        ...
        mapOpenInfoImpl.setEricssonStyle(true);
        mapOpenInfoImpl.setEricssonMsisdn(servFact.createAddressString(AddressNature.international_number, NumberingPlan.ISDN, "111222111222"));
        mapOpenInfoImpl.setEricssonVlrNo(servFact.createAddressString(AddressNature.international_number, NumberingPlan.ISDN,
                "0873124"));
