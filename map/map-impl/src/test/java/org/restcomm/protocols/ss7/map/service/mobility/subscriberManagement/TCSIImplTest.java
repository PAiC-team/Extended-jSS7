...
public class TCSIImplTest {
    ...
    private byte[] getEncodedData() {
        return new byte[] { -96, 23, 48, 18, 48, 16, 10, 1, 12, 2, 1, 3, -128, 5, -111, 17, 34, 51, -13, -127, 1, 1, -128, 1, 2 };
    }

    private byte[] getEncodedDataFull() {
        return new byte[] { -96, 68, 48, 18, 48, 16, 10, 1, 12, 2, 1, 3, -128, 5, -111, 17, 34, 51, -13, -127, 1, 1, 48, 39,
    ...
    public void testDecode() throws Exception {
        ...
        int tag = asn.readTag();
        TCSIImpl ind = new TCSIImpl();
        assertEquals(tag, 0);
        assertEquals(asn.getTagClass(), Tag.CLASS_CONTEXT_SPECIFIC);

        ind.decodeAll(asn);

        ArrayList<TBcsmCamelTDPData> lst = ind.getTBcsmCamelTDPDataList();
