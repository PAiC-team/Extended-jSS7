...
public class IpSmGwGuidanceImpl  extends SequenceBase implements IpSmGwGuidance {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        try {
            ...
            asnOutputStream.writeInteger(Tag.CLASS_UNIVERSAL, Tag.INTEGER, this.minimumDeliveryTimeValue);
            asnOutputStream.writeInteger(Tag.CLASS_UNIVERSAL, Tag.INTEGER, this.recommendedDeliveryTimeValue);
