...
public enum NetworkIdentificationPlanValue {
    ...
    unknown(0), threeDigitCarrierIdentification(0x01), fourDigitCarrierIdentification(0x02), spare_1(0x03),
    spare_2(0x04), spare_3(0x05), spare_4(0x06), spare_5(0x07), spare_6(0x08), spare_7(0x09),
    spare_8(0x0A), spare_9(0x0B), spare_10(0x0C), spare_11(0x0D), spare_12(0x0E), spare_13(0x0F);
