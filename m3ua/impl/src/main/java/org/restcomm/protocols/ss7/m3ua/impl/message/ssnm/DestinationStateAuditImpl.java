...
public class DestinationStateAuditImpl extends M3UAMessageImpl implements DestinationStateAudit {
    ...
    public DestinationStateAuditImpl() {
        super(MessageClass.SIGNALING_NETWORK_MANAGEMENT, MessageType.DESTINATION_STATE_AUDIT, MessageType.S_DESTINATION_STATE_AUDIT);
    }
    ...
    public void setRoutingContexts(RoutingContext routingContexts) {
        if (routingContexts != null) {
            parameters.put(Parameter.Routing_Context, routingContexts);
        }
    }
