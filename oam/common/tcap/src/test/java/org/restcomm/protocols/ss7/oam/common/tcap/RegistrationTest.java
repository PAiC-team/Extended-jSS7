...
import org.restcomm.protocols.ss7.tcap.TCAPCounterProviderImpl;
...
public class RegistrationTest {
    ...
    public void setUp() throws Exception {
        ...
        sccpStack = new SccpStackImpl("SccpStack", null);
        sccpStack.start();
    ...
    public void processingStatDataTest() throws Exception {
        ...
        cp.updateOutgoingDialogsPerApplicationContextName("20.1");
        ...
        for (CounterValue cv : cvs3.getCounterValues()) {
            ...
            } else if (cv.getCounterDef().getCounterName().equals("OutgoingDialogsPerApplicationContextName")) {
            ...
            } else if (cv.getCounterDef().getCounterName().equals("IncomingDialogsPerApplicationContextName")) {
