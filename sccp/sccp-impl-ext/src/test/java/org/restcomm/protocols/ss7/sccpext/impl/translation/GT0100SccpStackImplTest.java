 ...
 * @author baranowb
 */
public class GT0100SccpStackImplTest extends SccpHarnessExt {

    private SccpAddress a1, a2;

    public GT0100SccpStackImplTest() {
    }
    ...
    public void testRemoteRoutingBasedOnGT_DPC_SSN() throws Exception {
        ...
        GlobalTitle gt1 = super.sccpProvider1.getParameterFactory().createGlobalTitle(GT1_digits, 0, NumberingPlan.ISDN_MOBILE, null, NatureOfAddress.NATIONAL);
        GlobalTitle gt2 = super.sccpProvider1.getParameterFactory().createGlobalTitle(GT2_digits, 0, NumberingPlan.ISDN_TELEPHONY, null, NatureOfAddress.NATIONAL);
        ...
        SccpAddress rule1SccpAddress = super.sccpProvider1.getParameterFactory().createSccpAddress(RoutingIndicator.ROUTING_BASED_ON_GLOBAL_TITLE, super.sccpProvider1.getParameterFactory().createGlobalTitle(GT2_pattern_digits, 0,
        ...
        User u2 = new User(sccpStack2.getSccpProvider(), a2, a1, getSSN()) {
            ...
            protected boolean matchCalledPartyAddress() {
                SccpMessage msg = messages.get(0);
                SccpDataMessage udt = (SccpDataMessage) msg;
                SccpAddress addressToMatch = sccpProvider1.getParameterFactory().createSccpAddress(RoutingIndicator.ROUTING_BASED_ON_GLOBAL_TITLE, sccpProvider1.getParameterFactory().createGlobalTitle("021", 0, NumberingPlan.ISDN_TELEPHONY, null, NatureOfAddress.NATIONAL), getStack2PC(),
                        getSSN());
                if (!addressToMatch.equals(udt.getCalledPartyAddress())) {
                    return false;
                }
    ...
    public void testRemoteRoutingBasedOnGT() throws Exception {
        ...
        User u1 = new User(sccpStack1.getSccpProvider(), a1, a2, getSSN()) {
            ...
            protected boolean matchCalledPartyAddress() {
                ...
                // 2345678
                SccpAddress addressToMatch = sccpProvider1.getParameterFactory().createSccpAddress(RoutingIndicator.ROUTING_BASED_ON_DPC_AND_SSN, sccpProvider1.getParameterFactory().createGlobalTitle("2345678", 0, NumberingPlan.ISDN_MOBILE, null, NatureOfAddress.NATIONAL), getStack1PC(), getSSN());
                if (!addressToMatch.equals(udt.getCalledPartyAddress())) {
                    return false;
                }
                return true;
        ...
        User u2 = new User(sccpStack2.getSccpProvider(), a2, a1, getSSN()) {
            ...
            protected boolean matchCalledPartyAddress() {
                SccpMessage msg = messages.get(0);
                SccpDataMessage udt = (SccpDataMessage) msg;
                SccpAddress addressToMatch = sccpProvider1.getParameterFactory().createSccpAddress(RoutingIndicator.ROUTING_BASED_ON_DPC_AND_SSN, sccpProvider1.getParameterFactory().createGlobalTitle("021", 0, NumberingPlan.ISDN_TELEPHONY, null, NatureOfAddress.NATIONAL), getStack2PC(), getSSN());
                if (!addressToMatch.equals(udt.getCalledPartyAddress())) {
                    return false;
                }
                return true;
