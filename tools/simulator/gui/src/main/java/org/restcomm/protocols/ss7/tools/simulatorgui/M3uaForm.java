...
import org.restcomm.protocols.ss7.tools.simulator.level1.BIpChannelType;
import org.restcomm.protocols.ss7.tools.simulator.level1.M3uaExchangeType;
import org.restcomm.protocols.ss7.tools.simulator.level1.M3uaFunctionality;
import org.restcomm.protocols.ss7.tools.simulator.level1.M3uaIPSPType;
import org.restcomm.protocols.ss7.tools.simulator.level1.M3uaManMBean;
import org.restcomm.protocols.ss7.tools.simulator.level1.M3uaRoutingLabelFormat;
import org.restcomm.protocols.ss7.tools.simulator.level1.M3uaTrafficModeType;
...
public class M3uaForm extends JDialog {
    ...
    public M3uaForm(JFrame owner) {
        ...
        btnCancel.setBounds(401, 517, 117, 23);
        panel.add(btnCancel);
