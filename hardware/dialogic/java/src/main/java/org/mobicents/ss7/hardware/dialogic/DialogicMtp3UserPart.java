...
public class DialogicMtp3UserPart extends Mtp3UserPartBaseImpl {
    ...
    // FIXME: Check this point with Gilberto regarding the second parameter Ss7ExtInterface
                    ...
                    */
                    switch (gctmsg.getType()) {
                        ...
                        case DIALOGIC_MESSAGE_TYPE_MTP_MSG_STATUS:
                            ...
                            // FIXME: Validate this point with Gilberto because this breakdown the code
