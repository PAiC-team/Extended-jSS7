...
public class MemoryCongestionMonitorImpl extends BaseCongestionMonitor implements MemoryCongestionMonitor, Serializable {
    ...
    /**
     * @param backToNormalMemoryThreshold1 setting the Threshold 1 of alarm clearing
     */
    ...
    /**
     * @param backToNormalMemoryThreshold2 setting the Threshold 2 of alarm clearing
     */
    ...
    /**
     * @param backToNormalMemoryThreshold3 setting the Threshold 3 of alarm clearing
     */
    ...
    /**
     * @param memoryThreshold1 the memoryThreshold the Threshold 1 to alarm set
     */
    ...
    /**
     * @param memoryThreshold2 the memoryThreshold the Threshold 2 to alarm set
     */
    ...
    /**
     * @param memoryThreshold3 the memoryThreshold the Threshold 3 to alarm set
     */
