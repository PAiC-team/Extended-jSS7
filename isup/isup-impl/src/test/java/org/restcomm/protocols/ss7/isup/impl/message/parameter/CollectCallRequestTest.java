 ...
 */
public class CollectCallRequestTest extends ParameterHarness {

    public CollectCallRequestTest() {
        super();
    ...
    public void testBody1EncodedValues() throws SecurityException, NoSuchMethodException, IllegalArgumentException,
        ...
        CollectCallRequestImpl at = new CollectCallRequestImpl(getBody1());

        String[] methodNames = { "isCollectCallRequested" };
    ...
    public AbstractISUPParameter getTestedComponent() throws ParameterException {
        return new org.restcomm.protocols.ss7.isup.impl.message.parameter.CollectCallRequestImpl();
    }
