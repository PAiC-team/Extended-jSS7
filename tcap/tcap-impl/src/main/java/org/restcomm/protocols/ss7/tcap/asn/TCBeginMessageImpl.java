...
public class TCBeginMessageImpl implements TCBeginMessage {
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.protocols.ss7.tcap.asn.comp.TCBeginMessage# getOriginatingTransactionId()
     */
    ...
    public void encode(AsnOutputStream asnOutputStream) throws EncodeException {
        ...
        try {
            ...
            // Utils.writeTransactionId(asnOutputStream, this.originatingTransactionId, Tag.CLASS_APPLICATION, _TAG_OTX);
